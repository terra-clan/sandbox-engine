...
- **Timer Display**: Shows remaining TTL for the sandbox session with visual warnings
- **Template Info**: Displays the sandbox template name
- **Services Status**: Shows status of associated services (PostgreSQL, Redis, etc.)
- **Open Web UI**: Button to open the sandbox web interface
...
| `SANDBOX_TEMPLATE` | Template name | `backend-python` |
...
| `SANDBOX_WEB_URL` | URL to sandbox web UI | `https://sb-abc123.terra-sandbox.ru` |
